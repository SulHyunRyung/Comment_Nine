...
| 게시글 수정/삭제 | POST | /api/post-edit | {'user_id'=user_id, 'post_title'=post_title, 'post_content'=post_content} | 사용자 정보, 게시글 제목, 게시글 내용 |
| 게시글 수정/삭제 페이지 | GET | /post-edit  |  |   

| 댓글 수정/삭제 | POST | /api/comment-edit | {'user_id'=user_id,'comment_content'=comment_content } | 사용자 정보, 댓글 내용 |
| 댓글 수정/삭제 페이지 | GET | /comment-edit  |  |   
